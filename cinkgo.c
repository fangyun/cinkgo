...
// *INDENT-OFF*
enum engine_id {
	E_RANDOM, E_REPLAY, E_PATTERNSCAN, E_PATTERNPLAY, E_MONTECARLO, E_UCT,
#ifdef DISTRIBUTED
	E_DISTRIBUTED,
#endif
#ifdef DCNN
...
static engine_init_t engine_init[E_MAX] = { engine_random_init, engine_replay_init, engine_patternscan_init,
		engine_patternplay_init, engine_montecarlo_init, engine_uct_init,
#ifdef DISTRIBUTED
...
static void usage() {
	...
	fprintf(stderr, "Options: \n"
			...
			"      --compile-flags               show cinkgo's compile flags \n"
			...
			"                  Cinkgo will play fast on a fast computer, slow on a slow computer, \n"
			...
			"                  Cinkgo will spend a little less to allow for network latency and other \n"
			...
			" \n"
			"  Examples:       cinkgo -t =5000            5000 simulations per move \n"
			"                  cinkgo -t =5000:15000      max 15000 simulations per move \n"
			"                  cinkgo -t 20               20s per move \n"
			"                  cinkgo -t _600             10min game, sudden death \n"
			" \n");
}
...
static struct option longopts[] =
		{ { "fuseki-time", required_argument, 0, OPT_FUSEKI_TIME }, { "chatfile", required_argument, 0, 'c' }, {
				"compile-flags", no_argument, 0, OPT_COMPILE_FLAGS }, { "debug-level", required_argument, 0, 'd' }, {
				"dcnn", no_argument, 0, OPT_DCNN }, { "engine", required_argument, 0, 'e' }, { "fbook",
				required_argument, 0, 'f' }, { "joseki", no_argument, 0, OPT_JOSEKI }, { "gtp-port", required_argument,
				0, 'g' }, { "help", no_argument, 0, 'h' }, { "kgs", no_argument, 0, OPT_NOPASSFIRST }, { "log-file",
				required_argument, 0, 'o' }, { "log-port", required_argument, 0, 'l' }, { "nodcnn", no_argument, 0,
				OPT_NODCNN }, { "nojoseki", no_argument, 0, OPT_NOJOSEKI }, { "nopassfirst", no_argument, 0,
				OPT_NOPASSFIRST }, { "nopatterns", no_argument, 0, OPT_NOPATTERNS }, { "patterns", no_argument, 0,
				OPT_PATTERNS }, { "rules", required_argument, 0, 'r' }, { "seed", required_argument, 0, 's' }, { "time",
				required_argument, 0, 't' }, { "unit-test", required_argument, 0, 'u' }, { "verbose-caffe", no_argument,
				0, OPT_VERBOSE_CAFFE }, { "version", no_argument, 0, 'v' }, { 0, 0, 0, 0 } };
// *INDENT-ON*
...
int main(int argc, char *argv[]) {
	...
	if (forced_ruleset && !board_set_rules(b, forced_ruleset))
